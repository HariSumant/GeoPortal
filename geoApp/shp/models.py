...
db = Db(dbname='geoapp', user='postgres', password='1729', host='localhost', port='5432')
...
def publish_data(sender, instance, created, **kwargs):
    ...
    name = instance.name
    conn_str = 'postgresql://postgres:1729@localhost:5432/geoapp'
    ...
    geo.create_featurestore(store_name='geoApp', workspace='geoapp', db='geoapp',
                            host='localhost', pg_user='postgres', pg_password='1729', schema='data')
